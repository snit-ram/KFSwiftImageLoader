...
//                                self.randomizeImages()
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if (indexPath as NSIndexPath).row % 2 == 0 {
            ...
            cell.featuredImageView.loadImageFromURLString(self.imageURLStringsArray[(indexPath as NSIndexPath).row], placeholderImage: UIImage(named: "KiavashFaisali")) {
        ...
        // Odd indices should contain button cells.
            ...
            cell.featuredButtonView.loadImageFromURLString(self.imageURLStringsArray[(indexPath as NSIndexPath).row], placeholderImage: UIImage(named: "KiavashFaisali"), forState: UIControlState(), isBackgroundImage: false)
